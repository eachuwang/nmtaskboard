...
```bash
docker buildx build --platform linux/amd64 --load -f docker/Dockerfile -t nmtaskboard:2.2.2 .
docker pull --platform linux/amd64 postgres:16-alpine
docker save -o docker/nmtaskboard-linux-amd64.tar nmtaskboard:2.2.2 postgres:16-alpine
```

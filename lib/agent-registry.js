...
export const AGENT_TOOLS = Object.freeze({
  ...
  readTeamProgress: tool("readTeamProgress", "read", "report", []),
  draftTeamReport: tool("draftTeamReport", "read", "report", ["type", "range", "includeCompleted", "excludedTaskIds", "includeNextWeek", "templateId"]),
  draftTasks: tool("draftTasks", "write", "create", []),
  draftTaskActions: tool("draftTaskActions", "write", "none", []),
  draftAssignments: tool("draftAssignments", "write", "none", [])
});

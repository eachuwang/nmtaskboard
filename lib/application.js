import { createGitProviders } from "./git-providers.js";
import { createPersistence } from "./persistence.js";
import { localPersonalContext } from "./personal-space.js";
import { createMemoryObjectStore, createObjectStore } from "./storage.js";
...
export async function createApplicationContext(config, options = {}) {
  ...
  return Object.freeze({
    ...
    objectStore: options.objectStore || (persistence.driver === "json" ? createMemoryObjectStore() : createObjectStore(config, options)),
    gitProviders: options.gitProviders || createGitProviders(options.gitProviderHooks || {}),

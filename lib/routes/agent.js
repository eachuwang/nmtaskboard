...
import { AGENT_PLAN_ACTIONS, agentAnswerPrompt, agentPlanPrompt, agentTaskActionPrompt, agentTaskDraftPrompt } from "../agent-prompts.js";
...
export function register(app, ctx) {
  ...
  app.post("/api/agent/sessions", asyncH(async (req, res) => {
    ...
    const session = {
      ...
      status: "active", createdAt: new Date().toISOString(), messages: [], drafts: [], actionDrafts: []
    };

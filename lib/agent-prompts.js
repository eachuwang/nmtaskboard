...
每项操作使用任务 id。targetStatus 只能是 backlog、todo、in_progress、in_review、done、blocked、cancelled，未要求改状态则为 null。
...
今天是 ${today}。任务初始状态默认为 backlog。priority 只能是 urgent、high、medium、low、none。日期只能是 YYYY-MM-DD 或 null。

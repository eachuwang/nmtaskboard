...
export const AGENT_TOOL_NAMES = Object.freeze(["readBoard", "readTask", "readHistory", "readProgress", "readReport"]);
...
async function runTool(ctx, context, tool, args) {
  if (tool === "readReport") {
    ...
    return { type: parsed.type, range: evidence.range, timeZone: generated.timeZone, subject: generated.subject, evidence };
  }

...
export default function LegacySelect({ ariaLabel, className = "", placeholder = "请选择", options, value, onChange }) {
    ...
    <Select value={value} onValueChange={onChange}>
      <div className={cn("legacy-select", className)}>
        <SelectTrigger className="legacy-select-trigger group" aria-label={ariaLabel} value={value}>
          <span className="legacy-select-label">{selected?.label || placeholder}</span>
